...
if (isset($_POST['add_to_cart'])) {
   ...
   if ($check_cart->rowCount() > 0) {
      ...
      $update_cart = $conn->prepare("UPDATE `cart` SET quantity = quantity + ? WHERE pid = ? AND user_id = ?");
      $update_cart->execute([$qty, $pid, $user_id]);
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="flex">
            <div class="price"><span>ksh</span><?= $fetch_cart['price']; ?></div>
   ...
   <div class="cart-total">
      <p>cart total : <span>ksh<?= $grand_total; ?></span></p>
   ...
   <div class="more-btn">
      ...
      <a href="index.php#food-category" class="btn">continue shopping</a>
   </div>
